...
def main():
    if not os.path.exists('data/vanilla'):
    ...
    for dataset_type in dataset_types:
        ...
        for dataset in datasets:
            ...
            save_path = f'data/vanilla/{dataset_type}_{dataset}'
            ...
            for item in data:
                ...
                prompt = 'Given a passage, please paraphrase it. ' \
                         'The content should be the same. The passage is: {}'.format(claim)
