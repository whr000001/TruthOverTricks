...
def main():
    ...
    for dataset_type in dataset_types:
        ...
        for dataset in datasets:
            ...
            save_path = f'data/summary/{dataset_type}_{dataset}'
            ...
            for item in data:
                ...
                prompt = 'Summarize the following passage, ' \
                         'ensuring it contains the most information about the facts. ' \
                         'Meanwhile, avoid including sentiments, intonation, ' \
                         'and other factors affecting the factuality. ' \
                         ' The passage is: {}'.format(claim)
